...
namespace JourneyToTheCenterOfTheCell
{
    class CodexGui
    {
        ...
        public Panel GetPanel(ContentManager Content)
        {
            ...
            i1.AddChild(new Paragraph("Cell 1.",Anchor.Auto,null,null,0.8f));//pic description
            ...
            i2.AddChild(new Paragraph("Nucleus 2.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i3.AddChild(new Paragraph("Endoplasmic Reticulum 3.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i4.AddChild(new Paragraph("Lysosome 4.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i5.AddChild(new Paragraph("Peroxisome 5.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i6.AddChild(new Paragraph("Golgi Apparatus 6.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i7.AddChild(new Paragraph("Mitochondria 7.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i8.AddChild(new Paragraph("Cytoskeleton 8.", Anchor.Auto, null, null, 0.8f));//pic description
            ...
            i9.AddChild(new Paragraph("Selenocysteine 9.", Anchor.Auto, null, null, 0.8f));//pic description
