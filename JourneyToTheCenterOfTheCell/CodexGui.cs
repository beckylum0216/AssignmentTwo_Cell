         ...
         //       string text,
          ...
          //      Nullable<Vector2> size = null,
           ...
           // )
            ...
            Image i1 = new Image(Content.Load<Texture2D>("lockedInfoCodex"),new Vector2(120, 120),ImageDrawMode.Stretch, Anchor.TopLeft,new Vector2(0,10));// first pic
            i1.AddChild(new Paragraph("Cell",Anchor.Auto,null,null,0.8f));//pic description
            newPanel.AddChild(i1);
            Image i2 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.TopCenter, new Vector2(0, 10));// first pic
            i2.AddChild(new Paragraph("Lysosome", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i2);
            Image i3 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.TopRight, new Vector2(0, 10));// first pic
            i3.AddChild(new Paragraph("Peroxisome", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i3);
            Image i4 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.CenterLeft);// first pic
            i4.AddChild(new Paragraph("Endoplasmic Reticulum", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i4);
            Image i5 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.Center);// first pic
            i5.AddChild(new Paragraph("Golgi Apparatus", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i5);
            Image i6 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.CenterRight);// first pic
            i6.AddChild(new Paragraph("Mitochondria", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i6);
            Image i7 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.BottomLeft);// first pic
            i7.AddChild(new Paragraph("nucleus", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i7);
            Image i8 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.BottomCenter);// first pic
            i8.AddChild(new Paragraph("cytoskeleton", Anchor.Auto, null, null, 0.8f));//pic description
            newPanel.AddChild(i8);
            Image i9 = new Image(Content.Load<Texture2D>("lockedInfoCodex"), new Vector2(120, 120), ImageDrawMode.Stretch, Anchor.BottomRight);// first pic
